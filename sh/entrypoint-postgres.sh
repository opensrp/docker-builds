...
if [ ! -s "$PGDATA/PG_VERSION" ]; then
	...
	if [[ -n $DEMO_DATA_TAG -a ! -f /etc/migrations/.postgres_migrations_complete ]];then
	...
	if [ ! -f /etc/migrations/.postgres_migrations_complete -a -d /tmp/opensrp-server-${OPENSRP_SERVER_TAG}/assets/tbreach_default_view_configs ]; then
